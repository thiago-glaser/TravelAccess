            ...
            <div className="max-w-6xl mx-auto">
                <header className="mb-12 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-slate-400 mt-2">{t('admin.subtitle')}</p>
                    </div>
                    <button 
                        onClick={fetchLogs}
                        className="px-4 py-2 bg-gray-100 dark:bg-slate-800 hover:bg-slate-700 rounded-lg text-sm transition-colors border border-gray-200 dark:border-slate-700"
                    >
                        {t('admin.refresh')}
                    </button>
                </header>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-xl overflow-hidden">
                    <div className="overflow-x-auto">
                        <table className="w-full text-left">
                            <thead className="bg-gray-100 dark:bg-slate-800 text-gray-500 dark:text-slate-400 text-xs uppercase tracking-wider">
                                <tr>
                            ...
                            <tbody className="divide-y divide-slate-700">
                                {loading ? (
                                    ...
                                    logs.map((log) => (
                                        <tr key={log.ID} className="hover:bg-gray-50 dark:bg-slate-800/50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-500 dark:text-slate-400 max-w-xs truncate" title={log.userAgent}>
                                                {log.userAgent}
                                            </td>
                ...
                <div className="mt-8 text-center">
                    <Link href="/" className="text-slate-500 hover:text-blue-600 dark:text-blue-400 transition-colors inline-flex items-center gap-2">
