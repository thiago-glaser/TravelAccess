                    ...
                    <div className="bg-white p-6 rounded-2xl border border-gray-200">
                        ...
                        {newKey && (
                            <div className="mt-6 p-4 bg-green-500/10 border border-green-500/50 rounded-xl">
                                <p className="text-green-600 text-sm mb-2 font-medium">{t('keys.newKeyWarning')}</p>
                                        ...
                                        keys.map((key) => (
                                            <tr key={key.ID} className="hover:bg-gray-100 transition-colors">
                                                ...
                                                <td className="px-6 py-4">
                                                    <span className={`px-2 py-1 rounded-full text-xs font-bold ${key.IS_ACTIVE ? 'bg-green-500/10 text-green-600' : 'bg-red-500/10 text-red-600'}`}>
                                                ...
                                                <td className="px-6 py-4">
                                                    <button
                                                        ...
                                                        className="text-red-600 hover:text-red-300 text-sm font-medium transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                                                    >
                                                        {t('keys.revoke')}
                                                    </button>
                                                </td>
