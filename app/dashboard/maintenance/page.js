        ...
        <div className="min-h-screen bg-gray-50 dark:bg-slate-800/50 text-slate-900 p-8">
            <div className="max-w-3xl mx-auto">
                <header className="mb-12">
                    ...
                    <p className="text-gray-500 dark:text-slate-400 mt-2">{t('maintenance.subtitle')}</p>
                </header>
                ...
                <div className="grid gap-8">
                    ...
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-xl">
                        ...
                        <form onSubmit={handleAddMaintenance} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex flex-col gap-1">
                                <label className="text-sm text-gray-500 dark:text-slate-400 font-medium">{t('maintenance.carLabel')}</label>
                                <select
                                    value={selectedCarId}
                                    onChange={(e) => setSelectedCarId(e.target.value)}
                                    className="px-4 py-3 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-purple-500 outline-none transition-all"
                                    required
                            ...
                            <div className="flex flex-col gap-1">
                                <label className="text-sm text-gray-500 dark:text-slate-400 font-medium">{t('maintenance.dateTimeLabel')}</label>
                                <input
                                    type="datetime-local"
                                    step="1"
                                    value={maintenanceDate}
                                    onChange={(e) => setMaintenanceDate(e.target.value)}
                                    className="px-4 py-3 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-purple-500 outline-none transition-all w-full [color-scheme:light]"
                                    required
                                />
                            </div>

                            <div className="flex flex-col gap-1">
                                <label className="text-sm text-gray-500 dark:text-slate-400 font-medium">{t('maintenance.amountLabel')}</label>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="0.00"
                                        className="w-full pl-8 pr-4 py-3 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-purple-500 outline-none transition-all placeholder-gray-400"
                                        required
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-1 md:col-span-2">
                                <label className="text-sm text-gray-500 dark:text-slate-400 font-medium">{t('maintenance.descriptionLabel')}</label>
                                <textarea
                                    value={description}
                                    onChange={(e) => setDescription(e.target.value)}
                                    placeholder={t('maintenance.descriptionPlaceholder')}
                                    maxLength="1000"
                                    className="w-full px-4 py-3 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-purple-500 outline-none transition-all placeholder-gray-400 min-h-[100px]"
                                    required
                                />
                            ...
                            <div className="md:col-span-2 flex flex-col gap-2 mt-2">
                                <label className="text-sm text-gray-500 dark:text-slate-400 font-medium">{t('maintenance.receiptLabel')}</label>
                                <div className="flex flex-col items-start gap-4 p-4 border border-dashed border-gray-300 dark:border-slate-600 rounded-xl bg-gray-50 dark:bg-slate-800/50">
                                    <input
                                        ...
                                        className="text-sm text-gray-500 dark:text-slate-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-purple-50 file:text-purple-700 hover:file:bg-purple-100 transition-colors file:cursor-pointer"
                                    />
                                    {receiptPreview && (
                                        <div className="relative group">
                                            {receiptPreview === 'pdf' ? (
                                                <div className="h-32 w-24 rounded-lg border border-gray-200 dark:border-slate-700 bg-gray-100 dark:bg-slate-800 flex flex-col items-center justify-center p-2 text-red-500">
                                                    ...
                                                    <span className="text-[10px] uppercase font-bold mt-1 text-gray-500 dark:text-slate-400">{t('maintenance.pdfDocument')}</span>
                                                </div>
                                            ) : (
                                                <img src={receiptPreview} alt={t('maintenance.receiptPreviewAlt')} className="h-32 rounded-lg border border-gray-200 dark:border-slate-700 object-contain bg-gray-100 dark:bg-slate-800" />
                                            )}
                                            <button
                                                type="button"
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-xl overflow-hidden">
                        <div className="p-6 border-b border-gray-200 dark:border-slate-700 flex justify-between items-center bg-gray-50 dark:bg-slate-800/50">
                            ...
                            <span className="text-xs bg-gray-100 dark:bg-slate-800 text-gray-500 dark:text-slate-400 px-3 py-1 rounded-full border border-gray-200 dark:border-slate-700">{maintenanceEntries.length} {t('maintenance.total')}</span>
                        </div>
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 text-sm">
                                                        <div>
                                                            ...
                                                            <div className="text-gray-600 dark:text-slate-400">{localDate}</div>
                                                        </div>
                                                        <div className="sm:col-span-2">
                                                            ...
                                                            <div className="text-gray-600 dark:text-slate-400 whitespace-pre-wrap">{entry.description}</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="flex items-center gap-4 border-t md:border-t-0 md:border-l border-gray-200 dark:border-slate-700 pt-4 md:pt-0 md:pl-6">
                                                    {entry.hasReceipt ? (
                                                        <a
                                                            ...
                                                            className="flex flex-col items-center gap-1 group text-gray-500 dark:text-slate-400 hover:text-purple-600 transition-colors"
                                                            title={t('maintenance.viewReceipt')}
                                                        >
                                                            <div className="w-12 h-12 bg-gray-100 dark:bg-slate-800 rounded-xl flex items-center justify-center overflow-hidden border border-gray-200 dark:border-slate-700 group-hover:border-purple-400/50 transition-colors">
