        ...
        <div className="min-h-screen bg-gray-50 dark:bg-slate-800/50 text-slate-900 p-8">
            <div className="max-w-3xl mx-auto">
                <header className="mb-12">
                    ...
                    <p className="text-gray-500 dark:text-slate-400 mt-2">{t('cars.subtitle')}</p>
                </header>
                ...
                <div className="grid gap-8">
                    ...
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-xl">
                        ...
                        <form onSubmit={handleAddCar} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <input
                                ...
                                className="px-4 py-3 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all placeholder-gray-400 font-mono uppercase"
                            />
                            <input
                                type="text"
                                ...
                                className="px-4 py-3 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all placeholder-gray-400"
                            />
                            <button
                                type="submit"
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-xl overflow-hidden">
                        <div className="p-6 border-b border-gray-200 dark:border-slate-700 flex justify-between items-center bg-gray-50 dark:bg-slate-800/50">
                            ...
                            <span className="text-xs bg-gray-100 dark:bg-slate-800 text-gray-500 dark:text-slate-400 px-3 py-1 rounded-full border border-gray-200 dark:border-slate-700">{cars.length} {t('cars.total')}</span>
                        </div>
                        ...
                        <div className="divide-y divide-slate-700">
                            {loading ? (
                                ...
                                cars.map((car) => (
                                    <div key={car.ID} className="p-6 hover:bg-gray-50 dark:bg-slate-800/50 transition-colors">
                                                ...
                                                {editingId === car.ID ? (
                                                    <div className="grid gap-3">
                                                        <input
                                                            ...
                                                            className="flex-1 px-3 py-2 bg-white dark:bg-slate-900 border border-blue-300 rounded-lg text-sm outline-none ring-2 ring-blue-200 font-mono uppercase"
                                                        />
                                                        <input
                                                            type="text"
                                                            ...
                                                            className="flex-1 px-3 py-2 bg-white dark:bg-slate-900 border border-blue-300 rounded-lg text-sm outline-none ring-2 ring-blue-200"
                                                        />
                                                    ...
                                                    >
                                                        <div className="flex items-center gap-2 mb-1">
                                                            <span className="text-xs font-bold text-blue-600 dark:text-blue-400 tracking-wider uppercase">{t('cars.description')}</span>
                                                        </div>
                                                        <div className="text-lg text-gray-700 dark:text-slate-300 mb-3 flex items-center gap-2 font-medium">
                                                            {car.DESCRIPTION || <span className="italic text-slate-500 text-sm font-normal">{t('cars.noDescription')}</span>}
                                                            <svg className="w-3.5 h-3.5 text-slate-600 group-hover:text-blue-600 dark:text-blue-400 transition-colors opacity-0 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        ...
                                                        <div className="text-gray-500 dark:text-slate-400 text-sm py-1 font-mono uppercase flex items-center gap-2">
                                            ...
                                            {editingId !== car.ID && (
                                                <div className="flex items-center gap-3">
                                                    {distances[car.ID] !== undefined && (
                                                        <div className="px-4 py-2 text-sm font-semibold text-blue-600 dark:text-blue-400 bg-blue-400/10 rounded-lg border border-blue-400/20 whitespace-nowrap flex flex-col items-center justify-center">
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-4 py-2 text-xs font-bold text-slate-500 hover:text-blue-600 dark:text-blue-400 hover:bg-blue-400/10 rounded-lg border border-transparent hover:border-blue-400/20 transition-all uppercase tracking-widest flex items-center justify-center disabled:opacity-50"
                                                    >
