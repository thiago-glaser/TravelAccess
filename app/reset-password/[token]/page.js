        ...
        <div className="min-h-screen flex items-center justify-center bg-white dark:bg-slate-900 text-slate-900 relative">
            ...
            <div className="max-w-md w-full p-8 rounded-2xl bg-white dark:bg-slate-900 shadow-2xl border border-gray-200 dark:border-slate-700 backdrop-blur-sm">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 dark:text-slate-400 mt-2">{t('resetPassword.title')}</p>
                </div>
                ...
                {!success && (
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-600 dark:text-slate-400 mb-2">{t('resetPassword.password')}</label>
                            <input
                                id="input-password"
                                type="password"
                                value={password}
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-600 dark:text-slate-400 mb-2">{t('resetPassword.confirmPassword')}</label>
                            <input
